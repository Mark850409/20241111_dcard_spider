...
if __name__ == '__main__':
    ...
    # 根據是否為搜尋文章，調整 CSV 欄位
    if search_type.lower() == 'i':
        csv_columns = ['title', 'time', 'summary', 'image_url', 'article_link', 'school_name', 'like_count',
                       'comment_count', 'save_count']
    else:
        csv_columns = ['title', 'time', 'summary', 'image_url', 'article_link', 'like_count', 'comment_count',
                       'save_count']
    try:
